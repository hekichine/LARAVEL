      ...
      return this.ui.buttonGroup({
        ...
        children: [this.button({
          ...
          click: function click(event) {
            event.stopPropagation();
            var $parent = external_jQuery_default()('.' + className).find('.note-dropdown-category');
...
(external_jQuery_default()).summernote = external_jQuery_default().extend((external_jQuery_default()).summernote, {
  ...
  options: {
    ...
    icons: {
      ...
      'menuCheck': 'note-icon-category-check',
...
external_jQuery_default()(document).on('click.note-dropdown-category', function (e) {
  external_jQuery_default()(e.target).closest('.note-dropdown-category').parent().removeClass('open');
  external_jQuery_default()(e.target).closest('.note-dropdown-category').parent().find('.note-btn.active').removeClass('active');
});
...
var dropdown = renderer.create('<div class="note-dropdown-category" role="list"></div>', function ($node, options) {
...
var dropdownCheck = renderer.create('<div class="note-dropdown-category note-check" role="list"></div>', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
